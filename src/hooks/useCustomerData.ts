...
export function useCustomers(search?: string) {
  ...
  return useQuery({
    ...
    enabled: !!companyId,
    queryFn: async () => {
      let query = supabase.from("customers").select("*").order("name").eq("company_id", companyId as string);
      if (search) {
...
export function useCustomerStats() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      let query = supabase.from("customers").select("created_at").eq("company_id", companyId as string);
