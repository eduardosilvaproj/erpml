...
export function useProducts(filters?: {
  ...
  return useQuery({
    ...
    enabled: !!companyId,
    queryFn: () => productsService.fetchProducts(filters, companyId as string),
  });
}
...
export function useAllProducts(opts?: { activeOnly?: boolean }) {
  ...
  return useQuery({
    ...
    enabled: !!companyId,
    queryFn: () => productsService.fetchAllProducts(companyId as string, activeOnly),
  });
}
...
export function useCreateProduct() {
  ...
  return useMutation({
    mutationFn: (data: ProductFormData) => {
      ...
      return productsService.createProduct(data, companyId as string);
    },
    onSuccess: () => {
...
export function useUpdateProduct() {
  ...
  return useMutation({
    mutationFn: ({ id, data }: { id: string; data: ProductFormData }) => {
      if (!companyId) throw new Error("Empresa não identificada");
      return productsService.updateProduct(id, data, companyId as string);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["products"] });
...
export function useDeleteProduct() {
  ...
  return useMutation({
    mutationFn: (id: string) => {
      if (!companyId) throw new Error("Empresa não identificada");
      return productsService.deleteProduct(id, companyId as string);
    },
...
export function useCategories() {
  ...
  return useQuery({
    ...
    enabled: !!companyId,
    queryFn: () => productsService.fetchCategories(companyId as string),
  });
}
...
export function useSuppliers() {
  ...
  return useQuery({
    ...
    enabled: !!companyId,
    queryFn: () => productsService.fetchSuppliers(companyId as string),
  });
}
...
export function useCreateSupplier() {
  ...
  return useMutation({
    mutationFn: (data: { name: string; cnpj?: string; email?: string; phone?: string; address?: string }) => {
      if (!companyId) throw new Error("Empresa não identificada");
      return productsService.createSupplier(data, companyId as string);
    },
    onSuccess: () => {
...
export function useDeleteSupplier() {
  ...
  return useMutation({
    mutationFn: (id: string) => {
      if (!companyId) throw new Error("Empresa não identificada");
      return productsService.deleteSupplier(id, companyId as string);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["suppliers"] });
