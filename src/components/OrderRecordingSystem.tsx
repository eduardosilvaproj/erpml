    ...
    <>
      <div className="flex items-center gap-2 w-full">
        ...
        <Dialog>
          ...
          <DialogContent className="max-w-5xl w-[95vw] max-h-[92vh] overflow-hidden p-0 flex flex-col mx-auto">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 min-h-0">
              {selectedVideo ? (
                <div className="space-y-4">
                  ...
                  <div className="w-full max-w-4xl mx-auto aspect-video bg-black rounded-lg overflow-hidden border">
                    <video 
                      src={selectedVideo} 
                      controls 
                      autoPlay 
            ...
            <div className="p-4 border-t bg-gray-50 flex justify-end shrink-0">
               <Button variant="outline" onClick={() => setSelectedVideo(null)}>Fechar</Button>
            </div>
          </DialogContent>
        </Dialog>
      </div>
