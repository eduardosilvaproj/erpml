import {
  ...
  Building2, Crown, Lock, Megaphone, MessageSquare, Boxes, GraduationCap, ClipboardList
} from "lucide-react";
...
const menuItems = [
  ...
  { title: "Balanço Estoque", url: "/balanco-estoque", icon: ClipboardList },
                      ...
                      <TooltipProvider delayDuration={200}>
                        <Tooltip>
                          ...
                          <TooltipContent side="right" className="text-xs max-w-[200px] space-y-1 p-3">
                            <p className="font-medium">🔒 Recurso do plano {requiredPlan}</p>
                            <p className="text-muted-foreground">Faça upgrade para desbloquear esta funcionalidade.</p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    </SidebarMenuItem>
