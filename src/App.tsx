...
const DashboardSeparacao = lazy(() => import("./pages/DashboardSeparacao"));
                        ...
                        <AppLayout>
                          <Suspense fallback={<LoadingScreen />}>
                            <Routes>
                              ...
                              <Route path="/dashboard-separacao" element={<PlanProtectedRoute path="/dashboard-separacao"><DashboardSeparacao /></PlanProtectedRoute>} />
