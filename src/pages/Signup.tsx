...
import { UserPlus, Loader2, Beaker } from "lucide-react";
      ...
      <Card className="w-full max-w-md">
        ...
        <form onSubmit={handleSignup} noValidate>
            ...
            <div className="space-y-1">
              <div className="flex items-start gap-2">
                ...
                <label htmlFor="terms" className="text-sm text-muted-foreground leading-snug cursor-pointer">
                  ...
                  e a{" "}
                  <button type="button" className="text-primary underline hover:text-primary/80" onClick={() => setShowPrivacy(true)}>
          ...
          <CardFooter className="flex flex-col gap-3">
            <Button type="submit" className="w-full" disabled={loading || testAccountLoading || googleLoading || appleLoading || !acceptedTerms}>
