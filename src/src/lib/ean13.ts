...
/**
 * Generate a generic/internal EAN-13 code.
 * Prefix: 789 (Brazil) + 0000 (internal use marker) + 5 random digits + check digit.
 */
export function generateGenericEAN13(): string {
