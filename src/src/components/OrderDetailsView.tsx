    ...
    <Dialog open={!!ordemId} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-5xl w-[95vw] max-h-[92vh] overflow-hidden p-0 flex flex-col">
        {isLoading ? (
          ...
          <>
            <div className="bg-gray-50 border-b p-6 shrink-0">
            ...
            <DialogFooter className="flex flex-col sm:flex-row items-center justify-between gap-3 p-6 border-t bg-gray-50/50 shrink-0">
